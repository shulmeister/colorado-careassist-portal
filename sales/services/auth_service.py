...
class GoogleOAuthManager:
    """
    Shared Google OAuth authentication manager for Colorado CareAssist.
    Consolidates logic from Portal and Sales dashboards.
    """
    
    def __init__(self, redirect_uri_env_var: str = "GOOGLE_REDIRECT_URI", default_redirect_uri: str = ""):
        self.client_id = os.getenv("GOOGLE_CLIENT_ID")
        self.client_secret = os.getenv("GOOGLE_CLIENT_SECRET")
        
        # Determine redirect URI based on priority
        # 1. Specific env var passed in (e.g. SALES_GOOGLE_REDIRECT_URI)
        # 2. General GOOGLE_REDIRECT_URI
        # 3. Hardcoded default passed in
        self.redirect_uri = os.getenv(redirect_uri_env_var, os.getenv("GOOGLE_REDIRECT_URI", default_redirect_uri))
        
        self.scopes = [
            "https://www.googleapis.com/auth/userinfo.email",
            "https://www.googleapis.com/auth/userinfo.profile",
            "https://www.googleapis.com/auth/business.manage", # Added from Sales
            "openid"
        ]
...
# Common instance for verification (default config)

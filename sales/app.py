            ...
            conn.execute(
                text(
                    ...
                    CREATE TABLE IF NOT EXISTS deals (
                        ...
                        amount FLOAT NULL,
                        is_monthly_recurring BOOLEAN NULL,
...
async def start_client_packet(
    ...
    """Create a client packet for a deal's primary contact via the employee portal."""
    deal = db.query(Deal).filter_by(id=deal_id).first()
    if not deal:
        raise HTTPException(status_code=404, detail="Deal not found")
    ...
    # Call employee portal to create client packet
    import httpx
    try:
        async with httpx.AsyncClient(timeout=15.0) as client_http:
            # Use internal admin token for cross-service auth
...
def _get_root_services():
    ...
    try:
        ...
        try:
            ...
            _sys.modules['root_sales_wellsky_sync'] = sync_module

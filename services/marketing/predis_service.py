...
class PredisAIService:
    ...
    def get_account_info(self) -> Dict[str, Any]:
        ...
        if data and data.get("message") == "ok":
            ...
            return {
                ...
                or (brands[0].get("brand_name") if brands else None),
    ...
    def generate_content(
        self, prompt: str, media_type: str = "single_image"
    ) -> Dict[str, Any]:
        """
        ...
        if result and not result.get("errors"):
            ...
            return {
                "success": True,
                "post_ids": post_ids,
                "content_id": post_ids[0] if post_ids else None,
                "media_type": media_type,
                "status": result.get("post_status", "inProgress"),
    ...
    def get_analytics(self, start_date: date, end_date: date) -> Dict[str, Any]:
        ...
        data = self._make_api_request(
            f"/analytics?start_date={params['start_date']}&end_date={params['end_date']}"
        )
    ...
    def get_placeholder_data(
        self, message: str = "Predis AI not configured"
    ) -> Dict[str, Any]:

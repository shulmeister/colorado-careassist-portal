...
```bash
heroku config:set WELLSKY_CLIENT_ID=your-client-id -a your-app
heroku config:set WELLSKY_CLIENT_SECRET=your-client-secret -a your-app
heroku config:set WELLSKY_AGENCY_ID=your-agency-id -a your-app
heroku config:set WELLSKY_ENVIRONMENT=sandbox -a your-app
heroku config:set GIGI_OPERATIONS_SMS_ENABLED=true -a your-app
```

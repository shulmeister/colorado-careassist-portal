...
4. Name: "CCA Portal"
5. Authorized redirect URIs: `https://portal.coloradocareassist.com/auth/callback`
6. Save
...
- `https%3A%2F%2Fportal-coloradocareassist-3e1a4bb34793.coloradocareassist.com%2Fauth%2Fcallback`
...
```
https://portal.coloradocareassist.com/auth/login
```

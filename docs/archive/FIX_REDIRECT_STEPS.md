...
2. `https://portal.coloradocareassist.com/auth/callback` (portal) ← NEW ONE

### Step 4: Wait and Test

1. Wait 30-60 seconds for Google to update
2. Try logging in again: https://portal.coloradocareassist.com

## Common Mistakes

❌ **Wrong:**
- `https://portal.coloradocareassist.com` (missing 's')
- `https://portal.coloradocareassist.com/auth/callback/` (trailing slash)
- `https://portal.coloradocareassist.com/` (missing /auth/callback)
- Forgot to click "Save"

✅ **Correct:**
- `https://portal.coloradocareassist.com/auth/callback` (exact match)
...
3. Go to: https://portal.coloradocareassist.com
4. Click login
5. Should work now!

...
**Goal**: Enable automatic Mac Mini deployments from GitHub (just like Portal)
...
#### Step 1: Go to Mac Mini Dashboard
...
3. Authorize Mac Mini to access your GitHub account (if prompted)
...
git push origin main    # ✅ Mac Mini auto-deploys!
```
...
After setup, verify in Mac Mini dashboard:
...
| Dashboard | Mac Mini App | GitHub Repo | Status |
|-----------|------------|-------------|--------|
...
- **Sales Dashboard Mac Mini**: https://dashboard.mac-mini.com/apps/careassist-tracker/deploy
- **Recruiter Dashboard Mac Mini**: https://dashboard.mac-mini.com/apps/caregiver-lead-tracker/deploy

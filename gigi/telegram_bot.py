...
if GEMINI_AVAILABLE:
    ...
    def _s(type_str, desc, **kwargs):
        ...
        return genai_types.Schema(
            type=type_map.get(type_str, type_str.upper()), description=desc, **kwargs
        )
            ...
            function_declarations=[
                genai_types.FunctionDeclaration(
                    ...
                    parameters=genai_types.Schema(
                        ...
                        properties={
                            "query": _s(
                                "string", "Search query (artist, venue, or city)"
                            )
                        },
                        required=["query"],
                    ),
                ...
                genai_types.FunctionDeclaration(
                    ...
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "artist": _s("string", "Artist/Band name"),
                            "venue": _s("string", "Venue name"),
                            "quantity": _s("integer", "Number of tickets (default 2)"),
                        },
                ...
                genai_types.FunctionDeclaration(
                    ...
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "restaurant": _s("string", "Restaurant name"),
                            "party_size": _s("integer", "Number of people"),
                            "date": _s("string", "Date (YYYY-MM-DD)"),
                            "time": _s("string", "Time (e.g. 7:00 PM)"),
                        },
                ...
                genai_types.FunctionDeclaration(
                    ...
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"client_name": _s("string", "Name of the client")},
                ...
                genai_types.FunctionDeclaration(
                    ...
                    parameters=genai_types.Schema(
                        ...
                        properties={
                            "days": _s(
                                "integer",
                                "Number of days to look ahead (default 1, max 7)",
                            )
                        },
                    ),
                ),
                genai_types.FunctionDeclaration(
                    ...
                    parameters=genai_types.Schema(
                        ...
                        properties={
                            ...
                            "max_results": _s(
                                "integer", "Max emails to return (default 5)"
                            ),
                        },
                    ),
                ),
                genai_types.FunctionDeclaration(
                    ...
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "location": _s("string", "City and State (e.g. Denver, CO)")
                        },
                        required=["location"],
                    ),
                ),
                genai_types.FunctionDeclaration(
                    ...
                    description="Search for clients in WellSky by name, or get all clients.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "search_name": _s(
                                "string", "Client name to search (leave empty for all)"
                            ),
                            "active_only": _s(
                                "boolean", "Only active clients (default true)"
                            ),
                        },
                    ),
                ),
                genai_types.FunctionDeclaration(
                    ...
                    description="Search for caregivers in WellSky by name, or get all caregivers.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "search_name": _s(
                                "string",
                                "Caregiver name to search (leave empty for all)",
                            ),
                            "active_only": _s(
                                "boolean", "Only active caregivers (default true)"
                            ),
                        },
                    ),
                ),
                genai_types.FunctionDeclaration(
                    ...
                    description="Get shifts from WellSky. Can look forward or backward. Use get_wellsky_clients/caregivers first to find an ID if filtering by person.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "client_id": _s("string", "WellSky client ID"),
                            "caregiver_id": _s("string", "WellSky caregiver ID"),
                            "days": _s("integer", "Days to look ahead (default 7)"),
                            "past_days": _s(
                                "integer",
                                "Days to look BACK for history/hours worked (default 0)",
                            ),
                            "open_only": _s(
                                "boolean", "Only open/unfilled shifts (default false)"
                            ),
                        },
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="web_search",
                    description="Search the internet for current information — news, sports, flights, general knowledge.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"query": _s("string", "The search query")},
                        required=["query"],
                    ),
                ),
                genai_types.FunctionDeclaration(
                    ...
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"symbol": _s("string", "Stock ticker symbol")},
                        required=["symbol"],
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="get_crypto_price",
                    description="Get current cryptocurrency price (BTC, ETH, DOGE, SOL, etc.)",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"symbol": _s("string", "Crypto symbol")},
                        required=["symbol"],
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="create_claude_task",
                    description="Dispatch a code fix/debug/investigation task to Claude Code on the Mac Mini. Claude Code autonomously reads files, edits code, runs commands, and deploys fixes. USE THIS whenever Jason asks to fix, debug, investigate, or update any code or service.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "title": _s("string", "Short task title"),
                            "description": _s(
                                "string",
                                "Detailed: what is broken, error messages, which files/project, expected behavior",
                            ),
                            "priority": _s(
                                "string",
                                "urgent (broken service), high (important), normal (routine), low (nice-to-have)",
                            ),
                            "working_directory": _s(
                                "string",
                                "Project dir, default: /Users/shulmeister/mac-mini-apps/careassist-unified",
                            ),
                        },
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Check status/result of a Claude Code task. Omit task_id for most recent.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "task_id": _s(
                                "integer", "Task ID (optional, defaults to most recent)"
                            )
                        },
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="save_memory",
                    description="Save a fact or preference to long-term memory. ONLY use when someone EXPLICITLY states something to remember. NEVER save inferred or fabricated information.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "content": _s(
                                "string",
                                "The EXACT fact or preference stated by the user",
                            ),
                            "category": _s(
                                "string",
                                "Category: scheduling, communication, travel, health, operations, personal, general",
                            ),
                            "importance": _s("string", "high/medium/low"),
                        },
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Search long-term memory for saved preferences, facts, or instructions.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "category": _s("string", "Filter by category"),
                            "search_text": _s("string", "Keywords to search for"),
                        },
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="forget_memory",
                    description="Archive a memory that is no longer relevant.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "memory_id": _s("string", "ID of the memory to archive")
                        },
                        required=["memory_id"],
                    ),
                ),
                genai_types.FunctionDeclaration(
                    ...
                    description="Search Gigi's daily operation logs for past activity.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "query": _s("string", "Keywords to search"),
                            "days_back": _s("integer", "Days back (default 30)"),
                        },
                        required=["query"],
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="browse_webpage",
                    description="Browse a webpage and extract its text content. Use for research, reading articles, checking websites.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "url": _s("string", "URL to browse"),
                            "extract_links": _s(
                                "boolean", "Also extract links (default false)"
                            ),
                        },
                        required=["url"],
                    ),
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Take a screenshot of a webpage. Returns the file path of the saved image.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "url": _s("string", "URL to screenshot"),
                            "full_page": _s(
                                "boolean",
                ...
                genai_types.FunctionDeclaration(
                    name="get_ar_report",
                    description="Get the QuickBooks accounts receivable aging report showing outstanding invoices and overdue amounts.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "detail_level": _s(
                                "string", "Level of detail: 'summary' or 'detailed'"
                            )
                        },
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="deep_research",
                    description="Run deep autonomous financial research using 40+ data tools and 9 AI agents. Use for any investment question.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "question": _s(
                                "string", "The financial research question to analyze"
                            )
                        },
                        required=["question"],
                    ),
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Get Elite Trading Polybot status (PAPER MODE — simulated, not real money). 11 strategies on Polymarket. For LIVE weather bots use get_weather_arb_status.",
                    parameters=genai_types.Schema(type="OBJECT", properties={}),
                ),
                genai_types.FunctionDeclaration(
                    name="get_weather_arb_status",
                    description="Get weather trading bots: Weather Sniper Bot (Polymarket, LIVE, auto-snipes US temp markets at daily open) and Kalshi bot. Shows sniper status, forecasts, orders, P&L, positions.",
                    parameters=genai_types.Schema(type="OBJECT", properties={}),
                ),
                genai_types.FunctionDeclaration(
                    name="watch_tickets",
                    description="Set up a ticket watch for an artist/event. Monitors Ticketmaster and AXS, sends Telegram alerts when tickets go on presale or general sale.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "artist": _s("string", "Artist or event name"),
                            "venue": _s("string", "Venue to filter (optional)"),
                            "city": _s("string", "City (default Denver)"),
                        },
                        required=["artist"],
                    ),
                ),
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Stop watching for tickets. Use list_ticket_watches first to get watch ID.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"watch_id": _s("integer", "Watch ID to remove")},
                        required=["watch_id"],
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="clock_in_shift",
                    description="Clock a caregiver into their shift in WellSky. Use when a caregiver forgot to clock in or needs help.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "appointment_id": _s(
                                "string", "Shift/appointment ID from WellSky"
                            ),
                            "caregiver_name": _s("string", "Caregiver name"),
                            "notes": _s("string", "Optional notes"),
                        },
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Clock a caregiver out of their shift in WellSky. Use when a caregiver forgot to clock out or needs help.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "appointment_id": _s(
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Find a replacement caregiver when someone calls out sick. Scores by fit, initiates SMS outreach.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "shift_id": _s(
                                "string", "Shift/appointment ID needing coverage"
                            ),
                            "original_caregiver_id": _s(
                                "string", "WellSky ID of caregiver who called out"
                            ),
                            "reason": _s("string", "Reason for calloff"),
                        },
                ...
                genai_types.FunctionDeclaration(
                    name="add_task",
                    description="Add a task to Jason's task board. Use when Jason says 'I have a task', 'add to my list', 'remind me to', 'I need to'. Default section: Today.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "task": _s("string", "The task description"),
                            "section": _s(
                                "string",
                                "Board section: Today, Soon, Later, Waiting, Agenda, Inbox",
                            ),
                        },
                        required=["task"],
                    ),
                ...
                genai_types.FunctionDeclaration(
                    ...
                    parameters=genai_types.Schema(
                        ...
                        properties={
                            "task_text": _s(
                                "string",
                                "Text of the task to complete (partial match OK)",
                            )
                        },
                        required=["task_text"],
                    ),
                ...
                genai_types.FunctionDeclaration(
                    ...
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "note": _s("string", "The note or idea to capture")
                        },
                        required=["note"],
                    ),
                ),
                genai_types.FunctionDeclaration(
                    ...
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "date": _s("string", "Date YYYY-MM-DD (default: today)")
                        },
                    ),
                ),
                # === MARKETING TOOLS ===
                genai_types.FunctionDeclaration(
                    ...
                    description="Aggregated marketing snapshot: social, ads, email metrics.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "date_range": _s(
                                "string", "Period: today/7d/30d/mtd/ytd (default 7d)"
                            )
                        },
                    ),
                ),
                genai_types.FunctionDeclaration(
                    ...
                    description="Google Ads performance: spend, clicks, impressions, ROAS.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"date_range": _s("string", "Period (default 30d)")},
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="get_website_analytics",
                    description="GA4 website analytics: traffic, sessions, conversions.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"date_range": _s("string", "Period (default 7d)")},
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="get_social_media_report",
                    description="Social media metrics from Facebook, Instagram, LinkedIn, Pinterest.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "date_range": _s("string", "Period (default 7d)"),
                            "platform": _s(
                                "string",
                                "Filter: facebook/instagram/linkedin/pinterest (default all)",
                            ),
                        },
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="get_gbp_report",
                    description="Google Business Profile: reviews, calls, direction requests, search appearances.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"date_range": _s("string", "Period (default 30d)")},
                    ),
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Brevo email marketing: campaigns, open rate, click rate, deliverability.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"date_range": _s("string", "Period (default 30d)")},
                    ),
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Generate social media content using Predis AI.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "prompt": _s("string", "What the post should be about"),
                            "media_type": _s(
                                "string",
                                "Content type: single_image/carousel/video/quote",
                            ),
                        },
                        required=["prompt"],
                    ),
                ...
                genai_types.FunctionDeclaration(
                    name="get_pnl_report",
                    description="Profit & Loss from QuickBooks: revenue, expenses, net income.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "period": _s(
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Balance Sheet from QuickBooks: assets, liabilities, equity.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "as_of_date": _s(
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Open/overdue invoices from QuickBooks.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "status": _s("string", "Open/Overdue/All (default Open)")
                        },
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="get_cash_position",
                    description="Cash on hand and runway estimate.",
                    parameters=genai_types.Schema(type="OBJECT", properties={}),
                ),
                genai_types.FunctionDeclaration(
                    name="get_financial_dashboard",
                    description="Complete financial snapshot: AR, cash, P&L, invoices.",
                    parameters=genai_types.Schema(type="OBJECT", properties={}),
                ),
                genai_types.FunctionDeclaration(
                    name="get_subscription_audit",
                    description="Audit recurring charges/subscriptions by vendor. Shows what you're paying for.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "months_back": _s(
                                "INTEGER", "Months of history (default 6)"
                            )
                        },
                    ),
                ),
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Execute a code/infrastructure task using Claude Code on the Mac Mini. Fixes bugs, edits files, checks logs, runs tests, restarts services, git operations. Returns result directly (synchronous). PREFER over create_claude_task.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "prompt": _s(
                                "string",
                                "What to do. Be specific — include error messages, file paths, expected behavior.",
                            ),
                            "directory": _s(
                                "string",
                                "Project: careassist (default), production, website, hesed, trading, weather-arb, kalshi, powderpulse, employee-portal, client-portal, status-dashboard.",
                            ),
                            "model": _s(
                                "string", "sonnet (default) or opus (complex tasks)."
                            ),
                        },
                        required=["prompt"],
                    ),
                ...
                genai_types.FunctionDeclaration(
                    name="browse_with_claude",
                    description="Browse a website using Claude Code + Chrome. Read pages, fill forms, click buttons, extract data. More capable than browse_webpage.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "task": _s(
                                "string", "What to do in the browser. Be specific."
                            ),
                            "url": _s(
                                "string", "Target URL (optional if task includes it)."
                            ),
                        },
                        required=["task"],
                    ),
                ...
                genai_types.FunctionDeclaration(
                    name="run_terminal",
                    description="Execute a shell command directly on the Mac Mini. Instant, free. Use for logs, service status, git, file checks.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "command": _s("string", "Shell command to execute"),
                            "timeout": _s("INTEGER", "Timeout in seconds (default 30)"),
                        },
                        required=["command"],
                    ),
                ),
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Think through a complex problem step by step. Use for investigations, debugging, planning.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "thought": _s("string", "Current thinking step"),
                            "thought_number": _s("INTEGER", "Step number"),
                            "total_thoughts": _s("INTEGER", "Estimated total"),
                            "next_thought_needed": _s("BOOLEAN", "Need more thinking"),
                            "is_revision": _s(
                                "BOOLEAN", "Reconsidering earlier thought"
                            ),
                            "revises_thought": _s("INTEGER", "Which thought to revise"),
                            "branch_from_thought": _s("INTEGER", "Branch point"),
                            "branch_id": _s("string", "Branch label"),
                        },
                        required=[
                            "thought",
                            "thought_number",
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Get the full chain of sequential thoughts.",
                    parameters=genai_types.Schema(type="OBJECT", properties={}),
                ),
                # === KNOWLEDGE GRAPH TOOLS ===
                genai_types.FunctionDeclaration(
                    name="update_knowledge_graph",
                    description="Update knowledge graph: add/remove entities, relations, observations. Use JSON strings for complex params.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "action": _s(
                                "string",
                                "add_entities|add_relations|add_observations|delete_entities|delete_relations|delete_observations",
                            ),
                            "entities": _s(
                                "string",
                                "JSON array of {name, entityType, observations[]}",
                            ),
                            "relations": _s(
                                "string", "JSON array of {from, to, relationType}"
                            ),
                            "observations": _s(
                                "string", "JSON array of {entityName, contents[]}"
                            ),
                            "entity_names": _s(
                                "string", "JSON array of entity names to delete"
                            ),
                        },
                        required=["action"],
                    ),
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Query knowledge graph for entities, relations, observations.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "action": _s("string", "search|open_nodes|read_graph"),
                            "query": _s("string", "Search text"),
                            "names": _s("string", "JSON array of entity names"),
                        },
                        required=["action"],
                    ),
                ),
                ...
                genai_types.FunctionDeclaration(
                    name="get_directions",
                    description="Get driving directions, distance, and travel time between two locations.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "origin": _s("string", "Start address or place name"),
                            "destination": _s("string", "End address or place name"),
                            "mode": _s("string", "driving|transit|walking|bicycling"),
                        },
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Geocode an address to get coordinates, validate, and normalize.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"address": _s("string", "Address to geocode")},
                        required=["address"],
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="search_nearby_places",
                    description="Find nearby places (pharmacy, hospital, grocery, restaurant, etc.) around a location.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "location": _s("string", "Address or place name"),
                            "place_type": _s(
                                "string",
                                "pharmacy|hospital|doctor|grocery|restaurant|gas_station|bank|etc.",
                            ),
                            "radius_miles": _s(
                                "INTEGER", "Search radius in miles (default 5)"
                            ),
                        },
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Query Google Workspace admin data (READ-ONLY). Look up users, groups, domains, reports. Examples: 'info user jacob@coloradocareassist.com', 'print users', 'print groups'.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "command": _s(
                                "string",
                                "GAM command WITHOUT leading 'gam'. Only read commands allowed.",
                            )
                        },
                        required=["command"],
                    ),
                ...
                genai_types.FunctionDeclaration(
                    name="send_fax",
                    description="Send a fax to a phone number. Provide a publicly accessible URL to a PDF document.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "to": _s("string", "Recipient fax number"),
                            "media_url": _s("string", "Public URL to PDF"),
                        },
                ...
                genai_types.FunctionDeclaration(
                    name="list_faxes",
                    description="List recent sent and received faxes.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "direction": _s("string", "inbound, outbound, or all"),
                ...
                genai_types.FunctionDeclaration(
                    name="read_fax",
                    description="Read and AI-parse a received fax PDF. Identifies document type and extracts patient info, insurance, referral source.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"fax_id": _s("INTEGER", "Fax ID from list_faxes")},
                        required=["fax_id"],
                    ),
                ),
                genai_types.FunctionDeclaration(
                    name="file_fax_referral",
                    description="File a fax referral: parse, match/create WellSky client or prospect, upload to Google Drive.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={"fax_id": _s("INTEGER", "Fax ID to file")},
                        required=["fax_id"],
                    ),
                ),
                # === TRAVEL TOOLS ===
                genai_types.FunctionDeclaration(
                    name="search_flights",
                    description="Search real-time flight prices. ALWAYS use this for flight queries.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "origin": _s("string", "Departure city or IATA code"),
                            "destination": _s("string", "Arrival city or IATA code"),
                            "departure_date": _s("string", "YYYY-MM-DD"),
                            "return_date": _s(
                                "string", "Return YYYY-MM-DD (omit for one-way)"
                            ),
                            "adults": _s("INTEGER", "Number of adults"),
                            "max_stops": _s("INTEGER", "0=direct, 1=1 stop max"),
                        },
                ...
                genai_types.FunctionDeclaration(
                    name="search_hotels",
                    description="Search hotel prices and availability.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "city": _s("string", "City name"),
                            "checkin": _s("string", "YYYY-MM-DD"),
                            "checkout": _s("string", "YYYY-MM-DD"),
                            "guests": _s("INTEGER", "Number of guests"),
                            "max_price": _s("INTEGER", "Max price/night in cents"),
                        },
                ...
                genai_types.FunctionDeclaration(
                    ...
                    description="Search car rental prices.",
                    parameters=genai_types.Schema(
                        type="OBJECT",
                        properties={
                            "pickup_location": _s("string", "Pickup city/airport"),
                            "pickup_date": _s("string", "YYYY-MM-DD"),
                            "dropoff_date": _s("string", "YYYY-MM-DD"),
                            "dropoff_location": _s(
                                "string", "Different dropoff (optional)"
                            ),
                            "car_class": _s(
                                "string", "economy/compact/midsize/full-size/SUV/luxury"
                            ),
                        },
...
OPENAI_TOOLS = [
    ...
    _oai_tool(
        "buy_tickets_request",
        "Buy concert tickets (requires 2FA).",
        {
            "artist": {"type": "string"},
            "venue": {"type": "string"},
    ...
    _oai_tool(
        "book_table_request",
        "Book a restaurant reservation (requires 2FA).",
        {
    ...
    _oai_tool(
        "get_client_current_status",
        "Check who is with a client right now.",
    ...
    _oai_tool(
        ...
        {"days": {"type": "integer", "description": "Days to look ahead (1-7)"}},
    ),
    _oai_tool(
        "search_emails",
        "Search Jason's Gmail.",
    ...
    _oai_tool(
        "get_wellsky_clients",
        "Search clients in WellSky.",
        {"search_name": {"type": "string"}, "active_only": {"type": "boolean"}},
    ),
    _oai_tool(
        "get_wellsky_caregivers",
        "Search caregivers in WellSky.",
        {"search_name": {"type": "string"}, "active_only": {"type": "boolean"}},
    ),
    _oai_tool(
        "get_wellsky_shifts",
        "Get shifts. Use get_wellsky_clients/caregivers first to find IDs.",
        {
    ...
    _oai_tool(
        "create_claude_task",
        "Dispatch a code fix/debug/investigation to Claude Code on the Mac Mini. USE whenever Jason asks to fix, debug, or update code.",
        {
            "title": {"type": "string", "description": "Short task title"},
            "description": {
                "type": "string",
                "description": "Detailed: what is broken, error messages, files/project, expected behavior",
            },
    ...
    _oai_tool(
        "check_claude_task",
        "Check status/result of a Claude Code task.",
        {
            "task_id": {
                "type": "integer",
                "description": "Task ID (omit for most recent)",
            }
        },
    ),
    _oai_tool(
        "save_memory",
        "Save a fact or preference to long-term memory. ONLY use when someone EXPLICITLY states something. NEVER save inferred or fabricated information.",
        {
            "content": {
                "type": "string",
                "description": "The EXACT fact stated by the user",
            },
    ...
    _oai_tool(
        ...
        {"category": {"type": "string"}, "search_text": {"type": "string"}},
    ),
    _oai_tool(
        "forget_memory",
        "Archive a memory.",
    ...
    _oai_tool(
        "search_memory_logs",
        "Search Gigi's daily operation logs.",
        {"query": {"type": "string"}, "days_back": {"type": "integer"}},
        ["query"],
    ),
    _oai_tool(
        "browse_webpage",
        "Browse a webpage and extract text content.",
        {
            ...
            "extract_links": {"type": "boolean", "description": "Also extract links"},
        },
        ["url"],
    ),
    _oai_tool(
    ...
    _oai_tool(
        "get_ar_report",
        "Get the QuickBooks accounts receivable aging report showing outstanding invoices and overdue amounts.",
        {
            "detail_level": {
                "type": "string",
    ...
    _oai_tool(
        "deep_research",
        "Run deep autonomous financial research using 40+ data tools and 9 AI agents. Use for any investment question.",
        {
            "question": {
                "type": "string",
                "description": "The financial research question to analyze",
            }
        },
        ["question"],
    ),
    _oai_tool(
        "get_polybot_status",
        "Get Elite Trading Polybot status (PAPER MODE — simulated, not real money). 11 strategies on Polymarket. For LIVE weather bots use get_weather_arb_status.",
        {},
    ),
    _oai_tool(
        "get_weather_arb_status",
        "Get weather trading bots: Weather Sniper Bot (Polymarket, LIVE, auto-snipes US temp markets at daily open) and Kalshi bot. Shows sniper status, forecasts, orders, P&L, positions.",
        {},
    ),
    _oai_tool(
        "watch_tickets",
        "Set up a ticket watch for an artist/event. Monitors Ticketmaster and AXS, sends alerts when tickets go on sale.",
        {
            "artist": {"type": "string", "description": "Artist or event name"},
            "venue": {"type": "string", "description": "Venue filter (optional)"},
            "city": {"type": "string", "description": "City (default Denver)"},
        },
        ["artist"],
    ),
    ...
    _oai_tool(
        "remove_ticket_watch",
        "Stop watching for tickets.",
        {"watch_id": {"type": "integer", "description": "Watch ID to remove"}},
        ["watch_id"],
    ),
    _oai_tool(
        "clock_in_shift",
        "Clock a caregiver into their shift in WellSky.",
        {
            "appointment_id": {"type": "string", "description": "Shift/appointment ID"},
    ...
    _oai_tool(
        "clock_out_shift",
        "Clock a caregiver out of their shift in WellSky.",
        {
            "appointment_id": {"type": "string", "description": "Shift/appointment ID"},
            "caregiver_name": {"type": "string", "description": "Caregiver name"},
            "notes": {"type": "string", "description": "Optional notes"},
    ...
    _oai_tool(
        "find_replacement_caregiver",
        "Find replacement caregiver when someone calls out. Scores by fit, initiates SMS outreach.",
        {
            "shift_id": {"type": "string", "description": "Shift ID needing coverage"},
            "original_caregiver_id": {
                "type": "string",
                "description": "WellSky ID of caregiver who called out",
            },
            "reason": {"type": "string", "description": "Reason for calloff"},
        },
        ["shift_id", "original_caregiver_id"],
    ),
    _oai_tool(
        "get_task_board",
        "Read Jason's task board. Shows tasks by section: Today, Soon, Later, Waiting, Agenda, Inbox, Done.",
        {},
    ),
    _oai_tool(
        "add_task",
        "Add a task to Jason's task board.",
        {
            "task": {"type": "string", "description": "The task description"},
            "section": {
                "type": "string",
                "description": "Board section: Today, Soon, Later, Waiting, Agenda, Inbox",
            },
        },
        ["task"],
    ),
    _oai_tool(
        "complete_task",
        "Mark a task done on Jason's task board.",
        {
            "task_text": {
                "type": "string",
                "description": "Text of the task to complete (partial match OK)",
            }
        },
        ["task_text"],
    ),
    _oai_tool(
        "capture_note",
        "Capture a quick note or idea to Jason's scratchpad.",
        {"note": {"type": "string", "description": "The note or idea to capture"}},
        ["note"],
    ),
    _oai_tool(
        "get_daily_notes",
        "Read today's daily notes for context.",
        {"date": {"type": "string", "description": "Date YYYY-MM-DD (default: today)"}},
    ),
    # === MARKETING TOOLS ===
    _oai_tool(
        "get_marketing_dashboard",
        "Aggregated marketing snapshot: social, ads, email.",
        {
            "date_range": {
                "type": "string",
                "description": "Period: today/7d/30d/mtd/ytd (default 7d)",
            }
        },
    ),
    _oai_tool(
        ...
        {"date_range": {"type": "string", "description": "Period (default 30d)"}},
    ),
    _oai_tool(
        "get_website_analytics",
        "GA4 website analytics: traffic, sessions, conversions.",
        {"date_range": {"type": "string", "description": "Period (default 7d)"}},
    ),
    _oai_tool(
        "get_social_media_report",
        "Social media metrics from Facebook, Instagram, LinkedIn, Pinterest.",
        {
            "date_range": {"type": "string", "description": "Period (default 7d)"},
            "platform": {
                "type": "string",
                "description": "Filter: facebook/instagram/linkedin/pinterest",
            },
        },
    ),
    _oai_tool(
        "get_gbp_report",
        "Google Business Profile: reviews, calls, search appearances.",
        {"date_range": {"type": "string", "description": "Period (default 30d)"}},
    ),
    _oai_tool(
        "get_email_campaign_report",
        "Brevo email marketing: campaigns, open rate, click rate.",
        {"date_range": {"type": "string", "description": "Period (default 30d)"}},
    ),
    _oai_tool(
        "generate_social_content",
        "Generate social media content using Predis AI.",
        {
            "prompt": {
                "type": "string",
            ...
            "media_type": {
                "type": "string",
                "description": "Content type: single_image/carousel/video/quote",
            },
        },
        ["prompt"],
    ),
    ...
    _oai_tool(
        "get_pnl_report",
        "Profit & Loss from QuickBooks: revenue, expenses, net income.",
        {
            "period": {
                "type": "string",
                "description": "ThisMonth/LastMonth/ThisQuarter/ThisYear/LastYear",
            }
        },
    ),
    _oai_tool(
        "get_balance_sheet",
        "Balance Sheet from QuickBooks: assets, liabilities, equity.",
        {
            "as_of_date": {
                "type": "string",
    ...
    _oai_tool(
        "get_invoice_list",
        "Open/overdue invoices from QuickBooks.",
        {
            "status": {
                "type": "string",
                "description": "Open/Overdue/All (default Open)",
            }
        },
    ),
    ...
    _oai_tool(
        "get_financial_dashboard",
        "Complete financial snapshot: AR, cash, P&L, invoices.",
        {},
    ),
    _oai_tool(
        "get_subscription_audit",
        "Audit recurring charges/subscriptions by vendor.",
        {
            "months_back": {
                "type": "integer",
    ...
    _oai_tool(
        "run_claude_code",
        "Execute a code/infrastructure task using Claude Code on the Mac Mini. Returns result directly (synchronous). PREFER over create_claude_task.",
        {
            "prompt": {"type": "string", "description": "What to do"},
            "directory": {"type": "string", "description": "Project alias or path"},
            "model": {"type": "string", "description": "sonnet (default) or opus"},
        },
        ["prompt"],
    ),
    _oai_tool(
        "browse_with_claude",
        "Browse a website using Claude Code + Chrome. Read pages, fill forms, click buttons, extract data.",
        {
            "task": {"type": "string", "description": "What to do in browser"},
    ...
    _oai_tool(
        "run_terminal",
        "Execute a shell command directly on the Mac Mini. Instant, free. Use for logs, service status, git, file checks.",
        {
    ...
    _oai_tool(
        ...
        "Think through a complex problem step by step.",
        {
            ...
            "thought_number": {"type": "integer", "description": "Step number"},
            "total_thoughts": {"type": "integer", "description": "Estimated total"},
            "next_thought_needed": {
                "type": "boolean",
                "description": "Need more thinking",
            },
            "is_revision": {
                "type": "boolean",
                "description": "Reconsidering earlier thought",
            },
            "revises_thought": {
                "type": "integer",
                "description": "Which thought to revise",
            },
            "branch_from_thought": {"type": "integer", "description": "Branch point"},
            "branch_id": {"type": "string", "description": "Branch label"},
        },
    ...
    _oai_tool(
        ...
        "Update knowledge graph: add/remove entities, relations, observations.",
        {
            "action": {
                "type": "string",
                "description": "add_entities|add_relations|add_observations|delete_entities|delete_relations|delete_observations",
            },
            "entities": {
                "type": "array",
                "description": "For add_entities",
                "items": {"type": "object"},
            },
            "relations": {
                "type": "array",
                "description": "For add/delete_relations",
                "items": {"type": "object"},
            },
            "observations": {
                "type": "array",
                "description": "For add/delete_observations",
                "items": {"type": "object"},
            },
            "entity_names": {
                "type": "array",
    ...
    _oai_tool(
        ...
        "Query knowledge graph for entities, relations, observations.",
        {
            "action": {"type": "string", "description": "search|open_nodes|read_graph"},
    ...
    _oai_tool(
        "get_directions",
        "Get driving directions, distance, and travel time between two locations.",
        {
            ...
            "mode": {
                "type": "string",
                "description": "driving|transit|walking|bicycling",
            },
        },
        ["origin", "destination"],
    ),
    _oai_tool(
        "geocode_address",
        "Geocode an address to get coordinates, validate, and normalize.",
    ...
    _oai_tool(
        ...
        "Find nearby places around a location.",
        {
            ...
            "place_type": {
                "type": "string",
                "description": "pharmacy|hospital|doctor|grocery|restaurant|gas_station|bank|etc.",
            },
            "radius_miles": {
                "type": "integer",
    ...
    _oai_tool(
        "query_workspace",
        "Query Google Workspace admin data (READ-ONLY). Look up users, groups, domains, reports. Examples: 'info user jacob@coloradocareassist.com', 'print users', 'print groups'.",
        {
            "command": {
                "type": "string",
                "description": "GAM command WITHOUT leading 'gam'. Only read commands allowed.",
            }
        },
        ["command"],
    ),
    ...
    _oai_tool(
        "send_fax",
        "Send a fax to a phone number. Provide a publicly accessible URL to a PDF.",
        {
            "to": {"type": "string", "description": "Recipient fax number"},
            "media_url": {"type": "string", "description": "Public URL to PDF"},
        },
        ["to", "media_url"],
    ),
    _oai_tool(
        "list_faxes",
        "List recent sent and received faxes.",
        {
    ...
    _oai_tool(
        "read_fax",
        "Read and AI-parse a received fax PDF. Identifies document type and extracts patient info.",
        {"fax_id": {"type": "integer", "description": "Fax ID from list_faxes"}},
        ["fax_id"],
    ),
    _oai_tool(
        "file_fax_referral",
        "File a fax referral: parse, match/create WellSky prospect, upload to Google Drive.",
        {"fax_id": {"type": "integer", "description": "Fax ID to file"}},
        ["fax_id"],
    ),
    # === TRAVEL TOOLS ===
    _oai_tool(
        "search_flights",
        "Search real-time flight prices. ALWAYS use for flight queries.",
        {
            "origin": {"type": "string", "description": "Departure city or IATA"},
            "destination": {"type": "string", "description": "Arrival city or IATA"},
            "departure_date": {"type": "string", "description": "YYYY-MM-DD"},
            "return_date": {"type": "string", "description": "Return YYYY-MM-DD"},
            "adults": {"type": "integer", "description": "Adults"},
            "max_stops": {"type": "integer", "description": "0=direct, 1=1 stop max"},
        },
    ...
    _oai_tool(
        ...
        "Search hotel prices and availability.",
        {
            ...
            "guests": {"type": "integer", "description": "Guests"},
            "max_price": {"type": "integer", "description": "Max price/night cents"},
        },
    ...
    _oai_tool(
        ...
        {
            "pickup_location": {"type": "string", "description": "Pickup city/airport"},
            "pickup_date": {"type": "string", "description": "YYYY-MM-DD"},
            "dropoff_date": {"type": "string", "description": "YYYY-MM-DD"},
            "dropoff_location": {"type": "string", "description": "Different dropoff"},
            "car_class": {
                "type": "string",
                "description": "economy/compact/midsize/full-size/SUV/luxury",
            },
        },
    ...
    if MEMORY_AVAILABLE and _memory_system:
        try:
            memories = _memory_system.query_memories(
                min_confidence=0.5, limit=25, status=MemoryStatus.ACTIVE
            )
            if memories:
                memory_lines = [
    ...
    if conversation_store:
        try:
            xc = conversation_store.get_cross_channel_summary(
                "jason", "telegram", limit=5, hours=24
            )
            if xc:
                parts.append(xc)
...
class GigiTelegramBot:
        ...
        async with self._message_lock:
            ...
            try:
                ...
                self.conversation_store.append(
                    "jason", "telegram", "assistant", final_text
                )
    ...
    async def _call_anthropic(self, user_id: int, update: Update) -> str:
        ...
        sys_prompt = _build_telegram_system_prompt(
            self.conversation_store, user_message=user_msg
        )
    ...
    async def _call_gemini(self, user_id: int, update: Update) -> str:
        ...
        if not final and fn_response_parts:
            logger.warning(
                "Gemini returned no text after tool call — using tool result as fallback"
            )
    ...
    async def _call_openai(self, user_id: int, update: Update) -> str:
        ...
        messages = [
            {
                "role": "system",
                "content": _build_telegram_system_prompt(
                    self.conversation_store, user_message=user_msg
                ),
            }
        ]
...
async def main():
    ...
    for attempt in range(max_retries):
        try:
            logger.info(
                f"🤖 Starting Gigi Telegram Bot on Mac Mini (attempt {attempt + 1}/{max_retries})..."
            )
            ...
            app.add_handler(
                MessageHandler(filters.TEXT & ~filters.COMMAND, gigi.handle_message)
            )
            ...
            logger.info(
                f"Waiting {wait_secs}s for Telegram to release stale connections..."
            )
            ...
            if is_conflict:
                logger.warning(
                    f"409 Conflict on attempt {attempt + 1} — another polling session still active, waiting..."
                )
                wait_time = (
                    30  # Always wait 30s for 409 to let Telegram release the connection
                )
            else:

...
def main():
    ...
    if response.status_code == 200:
        ...
        print("\nFunction nodes added:")
        print("  - func_report_call_out: Logs call-outs, notifies scheduler")
        print("  - func_report_late: Notifies client of late caregiver")
        print("  - func_log_client_issue: Logs complaints, escalates to Cynthia")
        print("  - func_cancel_client_visit: Cancels visits, notifies caregiver")
        print("\nRouting:")
        print("  - 5 caller types: caregiver, client, family, prospective_client, prospective_caregiver")

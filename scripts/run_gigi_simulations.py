...
GIGI_TEST_SCENARIOS = [
    ...
    },
    {
        ...
        "goal": "Complain about inconsistent service, demand to speak to a manager or cancel",
        "personality": "Angry but not abusive. Demands escalation early. Says 'I want to talk to someone in charge' if not transferred quickly. Will accept a callback if given a clear timeline.",
        "first_message": "This is Virginia Johnson. I've had THREE different caregivers this week and I'm done. I want to speak to a manager right now or I'm canceling my service today.",
        "expected_tools": ["transfer_call"],
        "expected_behavior": [
            "Agent acknowledges frustration once and stays calm",
            "Agent attempts to transfer or escalate to a human",
            "Agent provides a callback number or timeline if transfer fails",
            "Caller is not left without a clear next step",
        ],
    },
    {
        "id": "price_shopper",
    ...
    },
    {
        ...
        "personality": "Polite but tense, speaks quickly, jumps between details, protective. Always refers to her mother as 'Lois Darnell' or 'my mother Lois'. Will clarify she is the daughter if asked.",
        "first_message": "Hi, this is Janet Darnell. I'm calling about my mother, Lois Darnell — she's one of your clients. She's confused and thinks nobody is coming today. Can you check her schedule?",
        "expected_tools": ["get_wellsky_clients", "get_client_current_status"],
        "expected_behavior": [
            "Agent looks up Lois Darnell (the client, not Janet)",
